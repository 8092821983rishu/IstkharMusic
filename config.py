...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", -1002588311865))

# Get this value from @MissRose_Bot on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", None))
#Vars For API End Pont.
YTPROXY_URL = getenv("YTPROXY_URL", 'https://tgapi.xbitcode.com') ## E.G https://yt.okflix.
YT_API_KEY = getenv("YT_API_KEY" , 'xbit_5GIB0KO8D29KMGKIBSEXJE' ) ## get your secret key from Mr cute x - @MR_CUTE_X
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/8092821983rishu/IstkharMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ganasupport")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+gHZCdInUIQo4N2I9")
